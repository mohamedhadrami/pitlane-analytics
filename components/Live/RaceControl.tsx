...
import type { LiveDriver, LiveDriverList, LiveRaceControlMessage, LiveRaceControlMessages } from "@/types/liveTiming.types";
        ...
        <div className="overflow-y-scroll">
            <div className="m-3 min-w-[400px] font-extralight">
                <ScrollShadow className="min-w-[300px] h-[400px]" size={50}>
                    {filteredRaceControl?.map((event: LiveRaceControlMessage, id: number) => (
